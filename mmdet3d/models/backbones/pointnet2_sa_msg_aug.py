...
class PointNet2SAMSGAUG(BasePointNet):
    ...
    def forward(self, points, image=None, xy=None):
        """Forward pass.
        ...
        for i in range(self.num_sa):
            ...
            if self.fusion_layer is not None:
                img, li_xyz, cur_features, l_xy_cor = self.fusion_layer(i, img, l_xy_cor,cur_xyz, cur_features, cur_indices,xy)
